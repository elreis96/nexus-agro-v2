      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <section className="mb-8 animate-fade-in">
            <h2 className="font-display text-xl font-semibold mb-4 text-gradient-gold">Visão Geral</h2>
          ...
          <section className="mb-8 animate-slide-up">
            <div className="chart-container">
              <h2 className="font-display text-xl font-semibold mb-2 text-gradient-gold">Tese Climática</h2>
              <p className="text-sm text-muted-foreground mb-4">
                Relação entre chuva (lag 60 dias) e preço do Boi Gordo - A chuva de hoje impacta o preço em ~60 dias
              </p>
          ...
          <section className="mb-8">
            <h2 className="font-display text-xl font-semibold mb-4 text-gradient-gold">Análise de Risco</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="chart-container">
                <h3 className="font-medium mb-3">Volatilidade Boi Gordo</h3>
                <VolatilityBoxplot data={volatilidade || []} asset="boi" isLoading={volLoading} />
              </div>
              <div className="chart-container">
                <h3 className="font-medium mb-3">Volatilidade Dólar</h3>
                <VolatilityBoxplot data={volatilidade || []} asset="dolar" isLoading={volLoading} />
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            <div className="chart-container">
              <h2 className="font-display text-xl font-semibold mb-2 text-gradient-gold">Correlação de Ativos</h2>
              <p className="text-sm text-muted-foreground mb-4">Dólar x JBS - Análise de dependência entre ativos</p>
