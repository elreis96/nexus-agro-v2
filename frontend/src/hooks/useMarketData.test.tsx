...
describe("useMarketData Hooks", () => {
  ...
  describe("useAnalytics", () => {
    it("should fetch all analytics data successfully", async () => {
      ...
      (apiClient.getVolatilityAnalysis as any).mockResolvedValue(mockVolatilityData);
      (apiClient.getCorrelationAnalysis as any).mockResolvedValue(mockCorrelationData);
      (apiClient.getLagAnalysis as any).mockResolvedValue(mockLagData);
    ...
    it("should handle API errors gracefully", async () => {
      (apiClient.getVolatilityAnalysis as any).mockRejectedValue(
        new Error("API Error"),
      );
      (apiClient.getCorrelationAnalysis as any).mockRejectedValue(
        new Error("API Error"),
      );
      (apiClient.getLagAnalysis as any).mockRejectedValue(
        new Error("API Error"),
      );
