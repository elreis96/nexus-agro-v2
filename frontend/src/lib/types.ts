...
export interface ViewCorrelacaoDolarJbs {
  ...
  valor_dolar: number;
  valor_jbs: number;
  correlacao?: number; // Campo calculado para análise
}
...
export interface ViewLagChuva60dBoi {
  ...
  data_lag?: string;  // alias para data_preco
  preco_boi?: number; // alias para valor_boi_gordo
  chuva_lag?: number; // alias para chuva_mm_lag_60d
}
